...
# This file was *autogenerated* from the file attack2.sage
from sage.all_cmdline import *   # import sage library

_sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_4 = Integer(4); _sage_const_256 = Integer(256); _sage_const_80 = Integer(80); _sage_const_0xc4c88d9d220a562bf95421c84d7c94160aa57eb538e1fce8204d1bf19eaecb46 = Integer(0xc4c88d9d220a562bf95421c84d7c94160aa57eb538e1fce8204d1bf19eaecb46); _sage_const_0xb39eaeb437e33087132f01c2abc60c6a16904ee3771cd7b0d622d01061b40729 = Integer(0xb39eaeb437e33087132f01c2abc60c6a16904ee3771cd7b0d622d01061b40729); _sage_const_16 = Integer(16); _sage_const_106058005610142779690166437300572023785265939629722543453418132696315520505889 = Integer(106058005610142779690166437300572023785265939629722543453418132696315520505889); _sage_const_30 = Integer(30)
...
class ecdsa_solver:
    def __init__(self, m=_sage_const_80 , known_bits=_sage_const_4 ):
        ...
        self.s_list = []
        self.r_list = []
        self.fake_init(m, max_k=_sage_const_2 **(_sage_const_256 -known_bits))
    ...
    def solve_cvp(self,LLL=False,block_size=_sage_const_30 ):
